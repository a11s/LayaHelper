		...
		*/
		__proto.updateMapLayersPos = function () {
			...
			for (var i = 0; i < len; i++) {
				...
				if (tMapLayer._gridSpriteArray.length > 0) {
					tMapLayer.updateAloneObject();
					tMapLayer.pos(-this._viewPortX * tMapLayer._speedRatioX, -this._viewPortY * tMapLayer._speedRatioY);
				}
			}
		}
		/**
	...
	*/
	...
	var MapLayer = (function (_super) {
		...
		*/
		...
		__proto.getSpeedRatioX = function () {
			return this._speedRatioX;
		}
		__proto.getSpeedRatioY = function () {
			return this._speedRatioY;
		}

		__proto.setSpeedRatio = function (rx, ry) {
			this._speedRatioX = rx;
			this._speedRatioY = ry;
